@echo off
echo Installing VS Code Extensions for Frontend Development...

code --install-extension seatonjiang.gitmoji-vscode ^
--install-extension aaron-bond.better-comments ^
--install-extension alefragnani.project-manager ^
--install-extension amandeepmittal.expressjs ^
--install-extension christian-kohler.npm-intellisense ^
--install-extension christian-kohler.path-intellisense ^
--install-extension codezombiech.gitignore ^
--install-extension dbaeumer.vscode-eslint ^
--install-extension devzstudio.mern-snippets ^
--install-extension donjayamanne.git-extension-pack ^
